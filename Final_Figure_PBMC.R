...
# colors <- c(
# "NK_cell"  = '#60c98b',
# "Monocyte_CD14" = "#652b7b",
# "CD8_T_cell" = "#bdb04a",
# "B_cell" = '#7768c8',
# "CD4_T_cell" = "#5b8d34",
# "Plasmacytoid_dendritic_cell" = "#cf6ab4",
# "Monocyte_FCGR3A" = '#bf7336',
# "Megakaryocyte" = '#5b94df',
# "Hematopoietic_stem_cell"    = '#b13e55',
# "Misclassification" = '#ea5148'
# )

colors = c(
"NK_cell"  = rgb(140, 86, 75, max=255), #BROWN
"Monocyte_CD14" = rgb(255, 127, 14, max=255), #ORANGE
"CD8_T_cell" =  rgb(214, 39, 40, max=255), #RED
"B_cell" =rgb(44, 160, 44, max=255), #GREEN
"CD4_T_cell" = rgb(31, 119, 180, max=255), #BLUE
"Plasmacytoid_dendritic_cell" = rgb(227, 119, 194, max=255), # PINK
"Monocyte_FCGR3A" = rgb(148, 103, 189, max=255), #PURPLE
"Megakaryocyte" = rgb(127, 127, 127, max=255), #GREY
"Hematopoietic_stem_cell"    = rgb(188, 189, 34, max=255)) # LIME
...
G1 <- annotation[annotation$labels == target & annotation$prediction == target, 'cell_names']
G2 <- annotation[annotation$labels == target & annotation$raw_predictions == obj , 'cell_names']
...
# pdf('./Plots/Final_MonFCVsUnassigned_VP.pdf')
# 	graphContrast(tmp," (Ctrl B > 0, FC>0.5)", 0, 0.5, 1)
# dev.off()
...
pdf('./Plots/Plots4Mohit/Final_PBMC_RAW_HM.pdf')
...
pdf('./Plots/Plots4Mohit/Final_PBMC_RAW_SuppDataHM.pdf', heigh=12)
...
pdf('./Plots/Plots4Mohit/Final_PBMC_NC_HM.pdf')
